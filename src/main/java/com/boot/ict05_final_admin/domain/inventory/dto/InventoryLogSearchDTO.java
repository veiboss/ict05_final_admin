 ...
 * 재고 로그 검색 조건 DTO.
 *
 * <p>/admin/inventory/log/{materialId} 화면의 검색 폼(type, 기간)을
 * Repository 계층으로 전달하기 위한 전용 DTO.</p>
 *
 * <ul>
 *   <li>materialId: 필수(경로 변수)</li>
 *   <li>type: INCOME / OUTGO / ADJUST / null(전체)</li>
 *   <li>startDate / endDate: 검색 기간(옵션)</li>
 * </ul>
 */
@Getter
@Setter
